...
def custom_topo():
    ...
    amlight_c1.start()
    amlight_s1 = net.addSwitch('amlightS1', listenPort=6701, dpid='0000000000000001')
    ...
    sax_c1.start()
    sax_s1 = net.addSwitch('saxS1', listenPort=6702, dpid='0000000000000002')
    ...
    tenet_c1.start()
    tenet_s1 = net.addSwitch('tenetS1', listenPort=6703, dpid='0000000000000003')
    ...
    internet2_c1.start()
    internet2_s1 = net.addSwitch('i2S1', listenPort=6704, dpid='0000000000000004')
    ...
    esnet_c1.start()
    esnet_s1 = net.addSwitch('esnetS1', listenPort=6705, dpid='0000000000000005')
    ...
    geant_london_s1 = net.addSwitch('geantUKS1', listenPort=6706, dpid='0000000000000006')
    ...
    geant_france_s1 = net.addSwitch('geantFRS1', listenPort=6707, dpid='0000000000000007')
    ...
    lhc_c1.start()
    lhc_s1 = net.addSwitch('lhcS1', listenPort=6708, dpid='0000000000000008')
